package Exoschap4.EE43MyClass;


public class EE43MyClass {

	/**
	 * This program simulates rolling a pair of dice over and over until the total
	 * showing on the two dice is 2. It reports the number of rolls it took to get a
	 * 2. (This was written to test the subroutine, rollFor.)
	 */
	 ...
	 *             if the parameter, N, is not a number that could possibly come up
	 *             on a pair of dice
	 */
