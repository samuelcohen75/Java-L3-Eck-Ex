package exochap5.EE57MyClass;

import java.util.Scanner;

public class EE57MyClass {
  ...
  static class SubtractionQuestion implements IntQuestion {
         ...
         /* (non-Javadoc)
       * @see exochap5.EE57MyClass.EE57MyClass.IntQuestion#getQuestion()
       */
      public String getQuestion() {
             return "What is " + a + " - " + b + " ?";
         }
         /* (non-Javadoc)
       * @see exochap5.EE57MyClass.EE57MyClass.IntQuestion#getCorrectAnswer()
       */
      public int getCorrectAnswer() {
             return a - b;
         }
